...
function CitiesProvider({ children }) {
	const [{ cities, isLoading, currentCity, error }, dispatch] = useReducer(reducer, initlaState);
...
function useCities() {
	...
	if (context === undefined) throw new Error('CitiesContext used out side CIties provider');
	return context;
}
