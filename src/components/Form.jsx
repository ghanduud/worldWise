...
function Form() {
		...
		function () {
			...
			async function fetchCityData() {
				try {
					...
					if (!data.countryCode) throw new Error("That's not city please click somewhere else");
	...
	if (!lat && !lng) return <Message message='Start by pressing on the map' />;

	if (geocodingError) return <Message message={geocodingError} />;

	return (
		<form className={`${styles.form} ${isLoading ? styles.loading : ''}`} onSubmit={handleSubmet}>
